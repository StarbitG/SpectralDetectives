label dia5finalruim:
    ...
    hide joseph 
    show erika s at right
    Erika "Ei, calma aí, ele não sabia, e como a gente vai saber se você não tá inventando essa história inteira?"
    hide erika 
    show joseph s at right
    Joseph "Eu... Eu não posso."
    show nate n
    Nathan "Se o que você está dizendo é verdade, precisamos ir até a biblioteca, talvez o David ainda esteja por lá, podemos grampeá-lo."
...
label bibliotecaday5ruim:
    ...
    Joseph "De fato, melhor eu conferir as câmeras, podemos descobrir o que David aprontou."
    Joseph "Enquanto vou verificar as gravações, será que vocês poderiam investigar e ver se não encontram nada de diferente?"
    "Joseph vai para os fundos verificar nas câmeras o que ele pode encontrar."
...
label biblioteca5ruim:
    ...
    if procuraprateleira >=1 and procurabancada >=1 and procuraestante >=1:
        ...
        Joseph "Não faz sentido! eu não coloquei isso aí, deve ter sido o David!!"
        Joseph "Preciso falar com a Vivian, ela vai saber o que fazer."
        Joseph "Acho melhor vocês dois irem para casa, é perigoso vocês dois ficarem por aqui."
        "Joseph fala isso praticamente empurrando a gente para fora da biblioteca."
        scene bg biblioteca fora noite with dissolve 
        show halfblack
        show joseph n at right
        Joseph "Vou acompanha-los até em casa, não posso deixa-los irem sozinhos com esse maníaco do David a solta."
        jump casadia5ruim
...
label casadia5ruim:
    ...
    show halfblack
    show nate n at left
    Nathan "O senhor está bem? Posso tentar falar com meu pai para te ajudar com toda essa situação, ele tem um cargo alto na polícia."
    show joseph f at right
    ...
    show nate ns
    Nathan "Pode me deixar um número para contato? Para caso descubra mais alguma coisa."
    Joseph "Ah, sim, claro."
...
label quartodia6ruim:
    ...
    "Acordo um pouco mais tarde do que o normal, o cansaço parece finalmente ter me encontrado."
    show halfblack
    ...
    hide john 
    show camilla n at right
    Camilla "Não sei, mas tá meio tarde já."
    show nate s
...
label delegaciadia6ruim:
    ...
    hide david 
    show joseph s2 at right
    Joseph "Mas não fui eu que coloquei essas coisas no cofre, e você sabe disso. Até porque você é o verdadeiro culpado!"
    hide joseph 
    show david b at right
    ...
    hide joseph 
    show david b at right
    David "Mas que acusação absurda! Você precisa provar o que está falando, ou as coisas vão ficar ainda pior para o seu lado."
    hide david 
    show joseph b at right
    Joseph "Não tenho como provar, você deletou as gravações das câmeras!"
    hide joseph 
    show david b at right
    David "Como que eu poderia deletar AS SUAS gravações?"
    hide david 
    ...
    show nate s2
    Nathan "Pai, escuta, você está cometendo um erro! Ele está falando a verdade, ele só não tem provas agora, mas se você der mais tempo a ele, tenho certeza qu—"
...
label casadia6ruim:
    ...
    show nate n at left
    Nathan "Eu só não tô afim... Isso tudo foi culpa minha. Se eu não tivesse me envolvido tanto, não teria atrapalhado a investigação e o Joseph não teria sido preso."
    Nathan "Não sei onde eu estava com a cabeça com essa ideia de investigação..."
    "Tiro todas as pistas da minha parede. Não vejo mais motivo para fazer isso..."
