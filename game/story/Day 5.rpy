label startday5:
    ...
    show nate n at left
    Nathan "... Alô?"
    Erika "Nathan! Finalmente consegui entrar em contato, você dormiu mais do que o normal hoje, tá tudo bem aí?"
...
label lojadia5:
    ...
    Lucas "Aparentemente o departamento de polícia quer aumentar a segurança na região enquanto eles não encontrarem o ladrão, e o David foi selecionado pra cuidar daqui."
    hide lucas
    show seb b at right
    ...
    if vivianescolha >= 1:
        "Se for para falar com alguém da polícia, acho que a Vivian pode ser uma opção mais confiável."
    ...
    menu:
        ...
        "Investigar por conta própria":
            show nate n at left
            Nathan "Acho melhor investigarmos por conta própria mesmo, a polícia não tem provas o suficiente para investigá-lo, então acho que eles não vão ajudar."
            show erika n at right
            Erika "Justo, na frente da biblioteca hoje à noite então?"
        ...
        "Entregar as chaves para o David" if moralfinalruim >= 1:
            ...
            show david f
            David "E o que você tem aí com você, meu bom?"
            David "...Senhor!"
