...
style say_dialogue: # Posição da fala
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("M. Principal") action MainMenu()
...
#screen navigation(): #código movido para "use navigation"
...
screen main_menu():
    ...
    fixed:
        ...
        if main_menu:
            ...
            imagebutton auto "gui/iniciar %s.png" xpos 670 ypos 470 focus_mask True action Start()
        ...
        imagebutton auto "gui/carregar %s.png" xpos 658 ypos 590 focus_mask True action ShowMenu("load")

        

        #textbutton _("Preferências") action ShowMenu("preferences")
        imagebutton auto "gui/opçoes %s.png" xpos 672 ypos 715 focus_mask True action ShowMenu("preferences")
        ...
        imagebutton auto "gui/Quit %s.png" xpos 720 ypos 825 focus_mask True action Quit(confirm=not main_menu)
        ...
        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
            ...
            imagebutton auto "gui/ajuda %s.png" xpos 1838 ypos 17 focus_mask True action ShowMenu("help")
        ...
        if renpy.variant("pc"):
            ...
            imagebutton auto "gui/Info %s.png" xpos 1830 ypos 995 focus_mask True action ShowMenu("about")
...
screen about():
    ...
    use game_menu(_("Sobre"), scroll="viewport"):
        ...
        vbox ypos 25:  # Set the ypos and xpos values as per your preference
...
# Código adicionado para esse projeto
